...
A categorized directory of technologies, tools, and practices documented in recent project work.

Listed entries document recent hands-on use from an AI-generated scan of project artifacts; they do not represent expertise or proficiency ratings.
...
- [Windows Subsystem for Linux (WSL)](technologies/platforms/windows-subsystem-for-linux-wsl.md) - Platform, operating system, or system capability for running software.
...
- [CVE Vulnerability Management](practices/security/cve-vulnerability-management.md) - Security practice for assessing, protecting, or operating systems.
- [Dependency Scanning](practices/security/dependency-scanning.md) - Security practice for assessing, protecting, or operating systems.
- [Disaster Recovery Planning](practices/security/disaster-recovery-planning.md) - Security practice for assessing, protecting, or operating systems.
...
- [Role-Based Access Control (RBAC)](practices/security/role-based-access-control-rbac.md) - Security practice for assessing, protecting, or operating systems.
...
- [Security Policy Documentation](practices/security/security-policy-documentation.md) - Security practice for assessing, protecting, or operating systems.
- [Security Review](practices/security/security-review.md) - Security practice for assessing, protecting, or operating systems.
- [SIEM (Security Information & Event Management)](practices/security/siem-security-information-and-event-management.md) - Security practice for assessing, protecting, or operating systems.
- [Software Composition Analysis (SCA)](practices/security/software-composition-analysis-sca.md) - Security practice for assessing, protecting, or operating systems.
- [Software Supply Chain Security](practices/security/software-supply-chain-security.md) - Security practice for assessing, protecting, or operating systems.
...
- [Vulnerability Remediation](practices/security/vulnerability-remediation.md) - Security practice for assessing, protecting, or operating systems.
- [Vulnerability Scanning](practices/security/vulnerability-scanning.md) - Security practice for assessing, protecting, or operating systems.
- [Web Application Firewall (WAF)](practices/security/web-application-firewall-waf.md) - Security practice for assessing, protecting, or operating systems.
- [XDR (Extended Detection & Response)](practices/security/xdr-extended-detection-and-response.md) - Security practice for assessing, protecting, or operating systems.
...
- [Code Review](practices/engineering/code-review.md) - Engineering practice for designing, building, testing, or operating software.
- [Go Testing](practices/engineering/go-testing.md) - Engineering practice for designing, building, testing, or operating software.
- [High Availability Design](practices/engineering/high-availability-design.md) - Engineering practice for designing, building, testing, or operating software.
- [Infrastructure as Code (IaC)](practices/engineering/infrastructure-as-code-iac.md) - Engineering practice for designing, building, testing, or operating software.
- [Integration Testing](practices/engineering/integration-testing.md) - Engineering practice for designing, building, testing, or operating software.
- [Microservices Architecture](practices/engineering/microservices-architecture.md) - Engineering practice for designing, building, testing, or operating software.
...
- [Agentic AI Workflows](practices/ai-machine-learning/agentic-ai-workflows.md) - Practice for designing, configuring, or using AI-enabled systems.
- [AI Agent Configuration](practices/ai-machine-learning/ai-agent-configuration.md) - Practice for designing, configuring, or using AI-enabled systems.
- [AI Agent Design & Orchestration](practices/ai-machine-learning/ai-agent-design-and-orchestration.md) - Practice for designing, configuring, or using AI-enabled systems.
- [AI Agent Development](practices/ai-machine-learning/ai-agent-development.md) - Practice for designing, configuring, or using AI-enabled systems.
- [AI Skill Authoring](practices/ai-machine-learning/ai-skill-authoring.md) - Practice for designing, configuring, or using AI-enabled systems.
- [Large Language Models (LLMs)](practices/ai-machine-learning/large-language-models-llms.md) - Practice for designing, configuring, or using AI-enabled systems.
- [Prompt Engineering](practices/ai-machine-learning/prompt-engineering.md) - Practice for designing, configuring, or using AI-enabled systems.
